...
namespace _06_真_坦克大战
{
    internal class GameObjectManager
    {
        ...
        private static NotMovething boss = null;
        ...
        private static int enemyBornCount = -100;
        ...
        public static void Start()
        {
            ...
            points[1].X = 7 * 30; points[0].Y = 0;

            points[2].X = 14 * 30; points[0].Y = 0;
        }
        ...
        public static void CreateWall(int x, int y, int count, Image img, List<NotMovething> wall)
        {
            int xPosition = x * 30;
            int yPosition = y * 30;
